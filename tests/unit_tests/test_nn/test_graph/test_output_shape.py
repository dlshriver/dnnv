...
def test_5():
    ...
    assert output_shape[0] == (1, 10)
    assert output_shape[1] == (1, 5)
...
def test_6():
    ...
    output_shape = op_graph.output_shape
    assert len(output_shape) == 2
    assert output_shape[0] == (1, 4)
    assert output_shape[1] == (1, 4)
