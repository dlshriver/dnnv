...
def test_abs_GreaterThan_abs_cnf():
    ...
    assert new_expr.propagate_constants().is_equivalent(
        And(
            ...
            Or(
                GreaterThan(Negation(x), y),
                GreaterThanOrEqual(x, Constant(0)),
                LessThan(y, Constant(0)),
            ),
            Or(
                GreaterThan(x, Negation(y)),
                LessThan(x, Constant(0)),
                GreaterThanOrEqual(y, Constant(0)),
            ),
            Or(
                GreaterThan(Negation(x), Negation(y)),
                GreaterThanOrEqual(x, Constant(0)),
                GreaterThanOrEqual(y, Constant(0)),
            ),
        )
...
def test_abs_GreaterThan_abs_dnf():
    x, y = Symbol("x"), Symbol("y")
    x.ctx.shapes[x] = ()
    x.ctx.types[x] = np.float32
    x.ctx.shapes[y] = ()
...
def test_abs_GreaterThan_abs_cnf_broadcasting():
    x, y = Symbol("x"), Symbol("y")
    x.ctx.shapes[x] = (2,)
    x.ctx.types[x] = np.float32
    x.ctx.shapes[y] = ()
    ...
    assert new_expr.propagate_constants().is_equivalent(
        And(
            ...
            Or(
                GreaterThan(Negation(x_0), y_0),
                GreaterThanOrEqual(x_0, Constant(0)),
                LessThan(y_0, Constant(0)),
            ),
            Or(
                GreaterThan(x_0, Negation(y_0)),
                LessThan(x_0, Constant(0)),
                GreaterThanOrEqual(y_0, Constant(0)),
            ),
            Or(
                GreaterThan(Negation(x_0), Negation(y_0)),
                GreaterThanOrEqual(x_0, Constant(0)),
                GreaterThanOrEqual(y_0, Constant(0)),
            ),
            Or(
            ...
            Or(
                GreaterThan(Negation(x_1), y_1),
                GreaterThanOrEqual(x_1, Constant(0)),
                LessThan(y_1, Constant(0)),
            ),
            Or(
                GreaterThan(x_1, Negation(y_1)),
                LessThan(x_1, Constant(0)),
                GreaterThanOrEqual(y_1, Constant(0)),
            ),
            Or(
                GreaterThan(Negation(x_1), Negation(y_1)),
                GreaterThanOrEqual(x_1, Constant(0)),
                GreaterThanOrEqual(y_1, Constant(0)),
            ),
        )
...
def test_abs_GreaterThan_dnf():
    ...
    assert new_expr.propagate_constants().is_equivalent(
        Or(
            And(
                GreaterThan(Negation(Symbol("x")), Constant(5)),
                LessThan(Symbol("x"), Constant(0)),
            ),
            And(
                GreaterThan(Symbol("x"), Constant(5)),
    ...
    assert new_expr.propagate_constants().is_equivalent(
        Or(
            And(
                GreaterThan(Constant(15), Negation(Symbol("x"))),
                LessThan(Symbol("x"), Constant(0)),
            ),
            And(
                GreaterThan(Constant(15), Symbol("x")),
                GreaterThanOrEqual(Symbol("x"), Constant(0)),
            ),
        ),
    )
...
def test_abs_GreaterThan_cnf_broadcasting_call():
    x = Symbol("x")
    x.ctx.shapes[x] = ()
    x.ctx.types[x] = np.float32
...
def test_abs_GreaterThan_cnf_broadcasting_noncall():
    x = Symbol("x")
    x.ctx.shapes[x] = (3,)
    x.ctx.types[x] = np.float32
    ...
    assert new_expr.propagate_constants().is_equivalent(
        And(
            Or(
                GreaterThan(Negation(x[Constant((0,))]), Constant(1)),
                GreaterThanOrEqual(x[Constant((0,))], Constant(0)),
            ),
            Or(
                GreaterThan(Negation(x[Constant((1,))]), Constant(1)),
                GreaterThanOrEqual(x[Constant((1,))], Constant(0)),
            ),
            Or(
                GreaterThan(Negation(x[Constant((2,))]), Constant(1)),
                GreaterThanOrEqual(x[Constant((2,))], Constant(0)),
            ),
            Or(
                GreaterThan(x[Constant((0,))], Constant(1)),
                LessThan(x[Constant((0,))], Constant(0)),
            ),
            Or(
                GreaterThan(x[Constant((1,))], Constant(1)),
                LessThan(x[Constant((1,))], Constant(0)),
            ),
            Or(
                GreaterThan(x[Constant((2,))], Constant(1)),
    ...
    assert new_expr.propagate_constants().is_equivalent(
        And(
            Or(
                GreaterThan(Constant(1), Negation(x[Constant((0,))])),
                GreaterThanOrEqual(x[Constant((0,))], Constant(0)),
            ),
            Or(
                GreaterThan(Constant(1), Negation(x[Constant((1,))])),
                GreaterThanOrEqual(x[Constant((1,))], Constant(0)),
            ),
            Or(
                GreaterThan(Constant(1), Negation(x[Constant((2,))])),
                GreaterThanOrEqual(x[Constant((2,))], Constant(0)),
            ),
            Or(
                GreaterThan(Constant(1), x[Constant((0,))]),
                LessThan(x[Constant((0,))], Constant(0)),
            ),
            Or(
                GreaterThan(Constant(1), x[Constant((1,))]),
                LessThan(x[Constant((1,))], Constant(0)),
            ),
            Or(
                GreaterThan(Constant(1), x[Constant((2,))]),
                LessThan(x[Constant((2,))], Constant(0)),
            ),
        )
    )
